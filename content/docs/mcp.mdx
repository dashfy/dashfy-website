...
<Callout type="info" title="Using Cursor?">
  The [Cursor plugin](/docs/cursor-plugin) bundles this MCP server together with the [Dashfy agent
  skill](/docs/skills) and project rules in a single installable package.
</Callout>
